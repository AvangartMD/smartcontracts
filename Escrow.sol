...
contract Escrow {
    ...
    function placeOrder(
        ...
        if (_timeline == 0) {
            ...
            timeline = block.timestamp.add(_timeline.mul(30)); //Change 30 to 1 for unit testing and 3600 for production
        }
        require(
            msg.sender == tokenAddress,
            "Only Token address can place orders"
        );
        ...
        returns (bool)
    {
        ...
        require(
            block.timestamp >
                bid[_order.tokenId][_editionNumber].timeStamp.add(180), //replace with 86400 in production //change this 10 for unit testing
